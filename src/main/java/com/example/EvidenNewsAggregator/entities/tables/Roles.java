...
public class Roles extends TableImpl<RolesRecord> {
    ...
    /**
     * The column <code>evidennewsaggregator.roles.role_id</code>.
     */
     ...
     */
    public final TableField<RolesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(45), this, "");
